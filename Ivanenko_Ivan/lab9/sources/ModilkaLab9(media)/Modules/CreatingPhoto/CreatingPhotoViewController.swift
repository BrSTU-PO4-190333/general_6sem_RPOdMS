...
class CreatingPhotoViewController: UIViewController {
	...
	private func configure() {
		...
		createdImageView.backgroundColor = .purple.withAlphaComponent(0.8)
		
		createPictureButton.backgroundColor = .purple
		createPictureButton.titleLabel?.textColor = .black
		createPictureButton.setTitle("Create a photo", for: .normal)
