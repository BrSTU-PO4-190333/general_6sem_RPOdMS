...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void calculate() {
        ...
        /*    if (clickedFirst == 0) {
            ...
            iv_11.setImageResource(R.drawable.print);
            iv_12.setImageResource(R.drawable.print);
            iv_13.setImageResource(R.drawable.print);
            iv_14.setImageResource(R.drawable.print);

            iv_21.setImageResource(R.drawable.print);
            iv_22.setImageResource(R.drawable.print);
            iv_23.setImageResource(R.drawable.print);
            iv_24.setImageResource(R.drawable.print);

            iv_31.setImageResource(R.drawable.print);
            iv_32.setImageResource(R.drawable.print);
            iv_33.setImageResource(R.drawable.print);
            iv_34.setImageResource(R.drawable.print);

            iv_41.setImageResource(R.drawable.print);
            iv_42.setImageResource(R.drawable.print);
            iv_43.setImageResource(R.drawable.print);
            iv_44.setImageResource(R.drawable.print);
    ...
    private void fontsOfCardsResources() {
        image101 = R.drawable.cplus1;
        image102 = R.drawable.csharp1;
        image103 = R.drawable.python1;
        image104 = R.drawable.java1;
        image105 = R.drawable.js1;
        image106 = R.drawable.swift1;
        image107 = R.drawable.oci1;
        image108 = R.drawable.asm1;

        image201 = R.drawable.cplus2;
        image202 = R.drawable.csharp2;
        image203 = R.drawable.python2;
        image204 = R.drawable.java2;
        image205 = R.drawable.js2;
        image206 = R.drawable.swift2;
        image207 = R.drawable.oci2;
        image208 = R.drawable.asm2;
