...
import com.example.lab11.R.drawable.*
import com.example.lab11.R.id.*
...
class MainActivity : AppCompatActivity() {
    ...
    val images: MutableList<Int> = mutableListOf(black, blue, cyan, green, orange, purple, red, yellow,
        black, blue, cyan, green, orange, purple, red, yellow)
