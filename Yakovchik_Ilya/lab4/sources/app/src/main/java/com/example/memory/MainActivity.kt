...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val images = mutableListOf(ic_cake, ic_chocolate, ic_fries, ic_pizza, ic_ramen, ic_salad, ic_soup, ic_steak)
    ...
    private fun updateViews() {
        cards.forEachIndexed { index, memoryCard ->
            ...
            if (memoryCard.isMatched)
                button.alpha = 0.1f
            button.setImageResource(if (memoryCard.isFaceUp) memoryCard.identifier else ic_creative_food)
        }
